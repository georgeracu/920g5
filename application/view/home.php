...
<head>
    ...
    <title>3D Apps Project</title>
</head>

<body>
    <div class="main main_contents">
        <nav class="navbar sticky-top navbar-expand-sm navbar_coca_cola">
            ...
            <button id="navbarSupportedContent" class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarsExample04" aria-controls="navbarsExample04" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <div class="collapse navbar-collapse" id="navbarsExample04">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Drinks</a>
                        <div class="dropdown-menu" aria-labelledby="dropdown04">
                            <a class="dropdown-item" href="coke.html">Coca-Cola</a>
                            <a class="dropdown-item" href="sprite/index.html">Sprite</a>
                            <a class="dropdown-item" href="pepper/index.html">Dr. Pepper</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="dropdown05" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Labs</a>
                        <div class="dropdown-menu" aria-labelledby="dropdown05">
                            <a class="dropdown-item" href="Lab_1/index.html">Lab 1</a>
        ...
        <div class="card-deck col-sm-12 text-center">
            <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                    <img src="assets/images/coca_cola.jpg" alt="Coca-Cola" width="400">
                    <p>
                    ...
                    <button type="button" class="btn btn-lg btn-block btn-primary"><a href="https://www.coca-cola.co.uk/drinks/coca-cola/coca-cola">Find out more
                            ...</a></button>
                </div>
            </div>
            <div class="card mb-4 shadow-sm">
    ...
    <footer class="pt-4 my-md-5 pt-md-5 border-top">
        <div class="row">
            <div class="col-12 col-md">
                <small class="d-block mb-3 text-muted">© 2021 George Racu</small>
            </div>
            <div class="col-6 col-md social">
    ...
    <script src="./scripts/js/jquery-3.5.0.js"></script>
    <script src="./scripts/js/bootstrap.bundle.js"></script>
    <script src="./scripts/js/bootstrap.bundle.js.map"></script>
